...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { description: @agency.description, governing_body: @agency.governing_body, jurisdiction: @agency.jurisdiction, name: @agency.name }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { description: @agency.description, governing_body: @agency.governing_body, jurisdiction: @agency.jurisdiction, name: @agency.name }
    assert_redirected_to agency_path(assigns(:agency))
  end
